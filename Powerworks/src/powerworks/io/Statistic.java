...
public enum Statistic {
    ...
    RENDER_OVERLAY_TO_GRAPHICS("Time to render overlay image to screen"), SHOW_BUFFER_STRAT("Time to show buffer strat"), TOTAL_RENDER_TIME("Total time to render"), DRAW_CHAT_BAR("Time to draw chat bar");
    String name;
